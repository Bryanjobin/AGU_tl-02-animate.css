...
// Récupérez le contexte de dessin 2D de votre canvas
const canvas = document.getElementById("myCanvas");
const ctx = canvas.getContext("2d");
// Définir la couleur de remplissage du triangle
ctx.fillStyle = "#8B2EB7";
// Inverser le triangle en utilisant la fonction de transformation scale()
ctx.scale(1, -1);
// Déplacez le point de départ en haut à gauche du canvas
ctx.translate(0, -canvas.height);
// Commencez à dessiner un chemin de triangle
ctx.beginPath();
// Placez le point de départ en bas à gauche du canvas
ctx.moveTo(0, canvas.height);
// Tracez une ligne jusqu'au coin inférieur droit du canvas
ctx.lineTo(canvas.width, canvas.height);
// Tracez une ligne jusqu'au coin supérieur droit du canvas
ctx.lineTo(canvas.width / 2, 0);
// Fermez le chemin en traçant une ligne jusqu'au point de départ
ctx.closePath();
// Remplissez le chemin avec la couleur de remplissage spécifiée
ctx.fill();
...
},{"./createPopper.js":"cHuNp","./modifiers/eventListeners.js":"hBKsL","./modifiers/popperOffsets.js":"6I679","./modifiers/computeStyles.js":"gDlm2","./modifiers/applyStyles.js":"4iMn4","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9tRox","1SICI"], "1SICI", "parcelRequirea7be")
